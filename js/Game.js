class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      if(index === player.index) {
        ...
        //Cambiar la posicion de la camara en la direccion Y.
  ...
  showRank(){
    swal({
      ...
      imageUrl: "https://cdn.pixabay.com/photo/2014/04/02/11/12/trophy-305554_960_720.png",
      imageSize: "100x100", 
